...
\begin{enumerate}
	...
	\item Obtiene parámetros de entrada, en nuestro caso, queremos tuits relativos a las elecciones del 28A , nuestro parámetro de búsqueda será  28A, 28Abril y Elecciones2019.
...
\begin{enumerate}
	...
	\item En nuestro análisis no nos interesan los signos de puntuación como \textit{!}, pero sí que nos interesa mantener otros como  \textit{:)}, por ello, una solución es eliminar aquellos ítems de tamaño inferior a 2 símbolos, con lo que mantendremos emoticonos y eliminaremos signos de puntuación y posibles tokens erróneos. 
