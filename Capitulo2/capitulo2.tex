...
Para la elaboración de memorias, notas, artículos así como para los procesos de datos menos complejos se ha utilizado el sistema descrito en la tabla \ref{ord_personal}. Por otro lado, todo el proceso basado en Big Data se ha llevado a cabo en el clúster de procesado de datos del grupo de investigación, este clúster está formado por 4 máquinas cuyas especificaciones pueden verse en la tabla \ref{cluster}.
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
	\end{center}
\caption{Especificaciones técnicas del clúster.}
\label{cluster}
\end{table}
...
\item \textbf{PySpark}: Pasarela entre Python y Spark que permite usar funciones de Spark de manera nativa en Python.
 \item \textbf{Spark}:  Entorno  de computación en clúster usado para elaborar los procesos de Big Data más complejos. 
...
\item \textbf{Carga de los datos}: Tras la obtención de los datos se hizo necesaria la carga y almacenamiento de los mismos en bases de datos de tipo MongoDB de manera que estos puedan ser cargados en el sistema posteriormente de manera eficiente. Esta etapa tuvo lugar en los primeros días de mayo de 2019.
...
\begin{table}[H]
	\begin{center}
		...
		Intel Core i5 & & & \\
		Clúster & 6000 & 6 años & 1 mes & 120\\ \bottomrule
		\end{tabular}
	\end{center}
...
\begin{table}[H]
	\begin{center}
		...
		\textbf{TOTAL} & 6301,25 euros \\ \bottomrule
		\end{tabular}
	\end{center}
