...
\item \textbf{Análisis de sentimientos}:  También se llevo a cabo un proceso de análisis de sentimientos sobre los datos  para categorizar los resultados y apoyar los patrones obtenidos desde el punto de vista de los sentimientos obtenidos, esta tarea tuvo lugar a finales de agosto de 2019. 
